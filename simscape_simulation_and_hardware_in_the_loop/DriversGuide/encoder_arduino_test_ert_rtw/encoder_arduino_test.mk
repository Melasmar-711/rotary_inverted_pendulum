###########################################################################
## Makefile generated for Simulink model 'encoder_arduino_test'. 
## 
## Makefile     : encoder_arduino_test.mk
## Generated on : Tue Jan 03 10:07:49 2023
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/encoder_arduino_test.elf
...
PRODUCT_NAME              = encoder_arduino_test
MAKEFILE                  = encoder_arduino_test.mk
MATLAB_ROOT               = C:/PROGRA~1/POLYSP~1/R2020a
MATLAB_BIN                = C:/PROGRA~1/POLYSP~1/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/AsU/senior 2/sem 1/Hybrid Control/project_files/send_to_osama/DriversGuide
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/mahmo/DOCUME~1/MATLAB/R2020a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/encoder_arduino_test.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/shared/svd/include -I$(START_DIR)/src -I$(START_DIR)/encoder_arduino_test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020a/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=encoder_arduino_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o encoder_arduino.o encoder_arduino_test.o encoder_arduino_test_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/encoder_arduino_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/encoder_arduino_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/encoder_arduino_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
encoder_arduino.o : $(START_DIR)/SYS/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


encoder_arduino_test.o : $(START_DIR)/encoder_arduino_test_ert_rtw/encoder_arduino_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


encoder_arduino_test_data.o : $(START_DIR)/encoder_arduino_test_ert_rtw/encoder_arduino_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/encoder_arduino_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/encoder_arduino_test_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/encoder_arduino_test_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/encoder_arduino_test_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
