...
typedef struct tag_Vdrvk2IQsOqPlWl1GaayPG Encoder_arduino_encoder_ardui_T;
...
#ifndef typedef_cell_encoder_arduino_test_T
#define typedef_cell_encoder_arduino_test_T

typedef struct tag_GtaT2TPu8wQVLKHBwLo3ME cell_encoder_arduino_test_T;

#endif                                 /*typedef_cell_encoder_arduino_test_T*/
...
{
  cell_encoder_arduino_test_T AvailablePwmPinNames;
};
