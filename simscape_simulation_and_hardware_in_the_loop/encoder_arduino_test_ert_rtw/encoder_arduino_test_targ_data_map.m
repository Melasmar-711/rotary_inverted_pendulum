  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% encoder_arduino_test_P.Saturation_UpperSat_e
	  section.data(43).logicalSrcIdx = 42;
	  section.data(43).dtTransOffset = 49;
	
	  ;% encoder_arduino_test_P.Saturation_LowerSat_j
  ...
  targMap.checksum0 = 2234704417;
  targMap.checksum1 = 3412799635;
  targMap.checksum2 = 3539478939;
  targMap.checksum3 = 2979686149;
